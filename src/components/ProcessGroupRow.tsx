...
export const ProcessGroupRow = memo(
  function ProcessGroupRow({ group, onKill, onCopy }: Props) {
        ...
        {expanded &&
          group.entries.map((entry) => (
            ...
            >
              ...
              <td className="px-3 py-1.5"></td>
              <td className="px-3 py-1.5 text-xs text-secondary">
              ...
              <td className="px-3 py-1.5">
                <div className="flex gap-1 justify-end">
                  <button
                    ...
                    className="btn-icon-sm text-muted"
  ...
  (prev, next) =>
    ...
    prev.group.entries.every((e, i) => e.id === next.group.entries[i]?.id),
);
