...
export const PortRow = memo(
  function PortRow({ entry, onKill, onCopy, isSelected, onSelect }: Props) {
    ...
    return (
      <>
        ...
        >
          ...
          {/* Address */}
          <td className="px-3 py-2 text-xs truncate max-w-[120px] text-secondary">
            {displayAddress}
          </td>
  ...
  (prev, next) =>
    ...
    prev.entry.port === next.entry.port &&
